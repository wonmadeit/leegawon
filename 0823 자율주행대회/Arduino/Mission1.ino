...
//int angleRange[8][2] = {{0, 0}, {494-4*20, 494-3*20}, {494-3*20, 494-2*20},  {494-2*20, 494-20}, {494-20, 494}, {494, 494+20}, {494+20, 494+2*20},{494+2*20, 494+3*20}};
...
int isRed = TrafficStatus::GREEN;
// 타겟과 현재비교하여 조향모터 동작함수
int sideDistance = 200;
//ROS Set up
ros::NodeHandle nh;
